...
/**
 * binary_tree_insert_left - insère un noeud comme fils gauche d'un parent
...
binary_tree_t *binary_tree_insert_left(binary_tree_t *parent, int value)
{
	...
	/* Si le parent avait déjà un fils gauche */
	if (parent->left != NULL)
	{
		new_node->left = parent->left;       /* l'ancien devient fils gauche du nouveau */
		parent->left->parent = new_node;     /* met à jour son parent */
	}

	/* Placement du nouveau noeud comme fils gauche du parent */
